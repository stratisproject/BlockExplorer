...
const getSelectedDetail = createSelector(getTokensState, (state: TokensState) => state.tokenDetails);
const getSelectedDetailLoading = createSelector(getTokensState, (state: TokensState) => state.detailLoaded);
