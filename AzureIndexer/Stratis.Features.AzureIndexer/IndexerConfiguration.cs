namespace Stratis.Features.AzureIndexer
{
    ...
    public class IndexerConfiguration
    {
        ...
        public NetworkPeer ConnectToNode(bool isRelay)
        {
            ...
            NetworkPeerFactory networkPeerFactory = new NetworkPeerFactory(this.Network, DateTimeProvider.Default, this.loggerFactory, new PayloadProvider().DiscoverPayloads(), null, null, null, this.AsyncProvider, null);
